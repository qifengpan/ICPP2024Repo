This code is transformed UIC based on DC originially from https://github.com/fabien-dournac/parallel-heat3d-f90
...
To modify the sizes of samples:
1) sequential code: modify size of k0 in explicitSeq.f90
2) parallelized code: modify size of k0 in explicitPar.f90

use make to compile the code, the cmake and openmpi are required, the version is recommend to use openmpi/4.1.2-gcc-11.2.0 to reproduce the results.
...
=================================================
3.1 Sequential code
1) Set the mesh size and number of samples (see settings in the paper)
...
5) change the number of samples, do step 2
