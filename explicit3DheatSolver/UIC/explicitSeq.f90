program heat
   ...
   double precision, dimension(16) :: result,k0
   ...
   !double precision ,dimension(32)::k0
   ...
   allocate(x(1:nSample,0:size_x+1,0:size_y+1,0:size_z+1))
   allocate(x0(1:nSample,0:size_x+1,0:size_y+1,0:size_z+1))
